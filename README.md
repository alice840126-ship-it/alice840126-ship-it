...
- 📚 **공인중개사 1차** - 민법, 부동산학개론 심화 학습
- 🏢 **지식산업센터 전문** - 덕은, 향동 지역 임대/매매 중개
- 🤖 **AI 자동화** - NotebookLM, Claude Code 활용 워크플로우 최적화
- 📝 **PKM 시스템** - 옵시디언 PARA 방법론 기반 지식 관리
...
![Claude](https://img.shields.io/badge/Claude-D1A475?style=for-the-badge&logo=anthropic&logoColor=white)
...
- **NotebookLM 퀴즈 자동화** - 공인중개사 1차 기출문제 자동 생성 (09:00~17:00, 80분 간격)
- **데일리 루틴 자동화** - 아침 일정 브리핑, 뉴스 큐레이션, 저녁 마감 브리핑
- **텔레그램 봇 연동** - 문자 요약, 일정 관리, 뉴스 속보
- **옵시디언 PKM** - 데일리 노트, 작업 로그, 세션 기록 4곳 동시 저장
...
🌅 아침 7:00
  ├─ 데일리 노트 생성 (옵시디언)
  ├─ 아침 일정 브리핑 (Google Calendar 5개 캘린더)
  └─ 아침 뉴스 (경제/부동산/IT)
